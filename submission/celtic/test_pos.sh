...
for SEED in 1;
do
OUTPUT_DIR="submission_Oct_15/celtic/bert-base-multilingual-cased-LR5e-5-epoch10-MaxLen128-BS32-TrainLangen,is,de-Rf3_en,is,de_s1_ours_1.0/checkpoint-best-5/"
OUTFILE="$1_$2.txt"
python analysis/weights/run_test_pos.py \
  --predict_save_prefix "" \
