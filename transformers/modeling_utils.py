...
def apply_chunking_to_forward(
    forward_fn: Callable[..., torch.Tensor], chunk_size: int, chunk_dim: int, layer_id, adapter_names, adapter_weights, attention_mask, *input_tensors 
) -> torch.Tensor:
    """
    ...
    # if num_args_in_forward_chunk_fn != len(input_tensors)+1:
    #     raise ValueError(
    ...
    return forward_fn(layer_id, adapter_names, adapter_weights, attention_mask, *input_tensors)
