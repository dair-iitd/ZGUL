            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
                    ...
                    if results["f1"] > best_score:
                        ...
                        if cur_epoch <= 5:
                            output_dir = os.path.join(args.output_dir, "checkpoint-5")
                        elif cur_epoch <= 10:
                            output_dir = os.path.join(args.output_dir, "checkpoint-10")
                        else:
                            output_dir = os.path.join(args.output_dir, "checkpoint-15")
...
args, _ = get_args()
args.data_dir = "/home/vipul/Adapters/fusion/data/masa/en_amh_swa_wol/" # to-change: supply data directory
#args.output_dir = "output/masa/masa_bert/" # to-change: supply output directory
