...
LANG2ID = {'en':0, 'hi':1, 'ar':2, 'mr':3, 'ta':4, 'bn':5, 'bho':6, 'amh':7, 'hau':8, 'ibo':9, 'kin':10, 'lug':11, 'luo':12, 'pcm':13, 'swa':14, 'wol':15, 'yor':16, 'bh':6, 'as':1, 'or':1}
#LANG2ID = {'en':0, 'hi':1, 'ar':2, 'mr':3, 'ta':4, 'bn':5, 'bho':6, 'amh':5, 'hau':5, 'ibo':5, 'kin':5, 'lug':5, 'luo':5, 'pcm':5, 'swa':5, 'wol':5, 'yor':5}
  ...
  with open(output_test_results_file, "a") as result_writer:
    for lang in args.predict_langs.split(','):
      ...
      if not args.adapter_weight:
        if (False or args.test_adapter) and not args.adapter_weight:
          pass
