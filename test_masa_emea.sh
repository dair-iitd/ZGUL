...
RF=$4
OUTPUT_DIR="african/bert-base-multilingual-cased-LR1e-4-epoch10-MaxLen128-TrainLangen,amh,swa,wol-Rf${RF}_en_conll,am,sw,wo_s42_slavic/checkpoint-best-10/"
