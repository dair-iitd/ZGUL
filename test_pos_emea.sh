...
RF=$4
#OUTPUT_DIR="submission_latest/celtic/bert-base-multilingual-cased-LR5e-5-epoch10-MaxLen128-BS32-TrainLangen,is,de-Rf3_en,is,de_s1_ours_1.0/checkpoint-best-5/"
...
OUTPUT_DIR="ckpt/slavic/bert-base-multilingual-cased-LR1e-4-epoch5-MaxLen128-TrainLangen,ru,cs-Rf3_en,ru,cs_s42_maxpool/checkpoint-best-5/"
